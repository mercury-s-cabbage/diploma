...
signal create_save_request()
signal load_save_request(save_id: String)
...
signal update_diary_ui(progress: Dictionary)
signal diary_theme_pressed(theme_id: String)
signal diary_page_pressed(theme_id: String, page_id: String)
